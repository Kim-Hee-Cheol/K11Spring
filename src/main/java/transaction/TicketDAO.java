...
public class TicketDAO {
	...
	//스프링JDBC를 사용하기 위한 멤버변수와 빈을 주입받기 위한 setter()
	...
	/*
	위 2개의 멤버변수는 servlet-context.xml에서 TransactionDAO 빈을 생성할 때
	초기화된다.
	 */
	...
	public void buyTicket(final TicketDTO dto) {
		...
		//2개의 업무를 하나의 프로세스로 처리하기 위해 try-catch 묶어준다.
		/*
		※ 테스트 시에는 아래 두개의 업무처리 로직을 try문 밖으로 이동한 후
		구매를 해본다. 6장 이상인 경우 pay테이블에서는 insert되지만
		...
		try {
			...
			/*
			티켓 구매갯수가 6이상인 경우 예외가 발생되어 모든 작업은 취소(rollback)
			처리된다. 
			 */

...
<body>
	...
	<!-- 컨트롤러 : RequestMapping Controller.java-->
...
1. 요청명을 결정한다.
	-> di/myCalculator
2. 컨트롤러 생성한 후 해당 요청명을 매핑안 메소드 정의
...
5. 파일 다운로드를 위해 빈을 생성할 때
 ...
 -->	
	...
	<!-- 
	트랜잭션의 개념
	- 인터넷 뱅킹의 경우 A가 B에게 송금을 진행하는 경우 A에서는 출금이되었으나
	B에게는 입금이 되지 않은 상황이 발생된다면 해당 거래는 취소가 되어야 한다.
	-이와같이 양쪽 모두 만족되어야 하나의 프로세스를 완료처리 할 수 있도록
	해주는 기법을 트랜잭션 이라고 한다.
	...
	절차
	1. 트랜잭션 매니져를 사용하는 경우
		1-1. 오라클 드라이버, SPRING-JDBC 에 대한 의존설정을 한다.
